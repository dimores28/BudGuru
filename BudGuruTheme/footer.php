					...
					<div class="footer__col">
						...
						<ul class="footer__contact-list">
							<li class="footer__contact-list-item">
								<a class="footer__contact-list-link" href="tel:<?echo get_field('phone', 'option'); ?>">
							...
							<li class="footer__contact-list-item">
								<a class="footer__contact-list-link" href="mailto:<?php echo get_field('email', 'option'); ?>">
							...
							<li class="footer__contact-list-item">
								<a class="footer__contact-list-link" href="<?echo get_field('google_map_url', 'option'); ?>">
