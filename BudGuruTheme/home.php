                    ...
                    <div class="consultation__form-wrap">
                        <form class="consultation__form">
                            ...
                            <div class="consultation__field-wrap">
                                ...
                                <input class="consultation__form-input" type="text" id="user-name" name="user-name" placeholder="Ваше імʼя" aria-label="Ваше імʼя">
                                <input class="consultation__form-input" type="text" id="input-phone" name="phone" placeholder="Номер телефону" aria-label="Номер телефону" />
                                <textarea class="consultation__form-input consultation__form-textarea" name="question" id="input-question" placeholder="Ваше питання" aria-label="Ваше питання"></textarea>
                                <input class="consultation__btn-submit btn" type="submit" value="Відправити заявку" aria-label="Відправити заявку">
                            </div>
        ...
        <section class="our-services">
            <div class="our-services__container">
                <div class="our-services__head-block">
                    ...
                    <a href="#" class="our-services_btn btn">Дивитись більше</a>
                </div>

                <div class="our-services__row">
                    <div class="our-services__smal-col">
                        <a href="#" class="our-services__smal-col_link">
                            <svg width="25" height="25" viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div class="our-services__big-col">
                        <a href="#" class="our-services__big-col_link our-services__big-col_link-mobile">
                            <svg width="25" height="25" viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M23.3031 1.74685L1.14708 23.9029M23.3031 1.74685L23.2357 20.6704M23.3031 1.74685L4.37957 1.81419" stroke="#1E1E1E" stroke-width="1.58" stroke-linecap="round" stroke-linejoin="round" />
                            </svg>
                        </a>
                ...
                <div class="our-services__row">
                    <div class="our-services__smal-col">
                        <a href="/service2.html" class="our-services__smal-col_link">
                            <svg width="25" height="25" viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M23.3031 1.74685L1.14708 23.9029M23.3031 1.74685L23.2357 20.6704M23.3031 1.74685L4.37957 1.81419" stroke="#1E1E1E" stroke-width="1.58" stroke-linecap="round" stroke-linejoin="round" />
                            </svg>
                        </a>
            ...
            <div class="work-performed__container">
                <div class="work-performed__top-block">
                    ...
                    <div class="work-performed__head-wrap">
                        ...
                        <a href="#" class="work-performed__btn btn">
                            Дивитись більше
                        </a>
                    </div>

                    <div class="work-performed__filters">
                        <a href="#" class="work-performed__filters_link active">
                            Житлові приміщення
                        </a>
                        <a href="#" class="work-performed__filters_link">
                ...
                <div class="work-performed__grid work">

                    <div class="work__card work__card_1">
                        ...
                        <div class="work__text">
                            <h4 class="work__title">
                                <span>Дизайн 2x</span>  кімнатної квартири
                                в ЖК “Варшавський”
                            </h4>
                        </div>
                    ...
                    <div class="work__card work__card_2">
                        ...
                        <div class="work__text">
                            <h4 class="work__title">
                                <span>Ремонт та дизайн</span> 2x  кімнатної квартири
                    ...
                    <div class="work__card work__card_4">
                        ...
                        <div class="work__text">
                            <h4 class="work__title">
                                <span>Дизайн</span> квартири-студії
                                в ЖК “Озерний гай”
                            </h4>
                        </div>
        ...
        <section class="projects">
            <div class="projects__container">
                <div class="projects__top-block">
                    ...
                    <a href="#" class="projects__btn btn" data-da=".projects__btn-wrap,768,0">
                        Дивитися більше
                    </a>
                </div>
                ...
                <div class="blog_top-block">
                    <div class="blog__box">
                        ...
                        <div class="blog__filters filters" data-da=".filters-wrap,1120,0">
                            <a href="#" class="filters__item">Всі теми</a>
                            <a href="#" class="filters__item">Ремонт</a>
                            <a href="#" class="filters__item">Дизайн</a>
                            <a href="#" class="filters__item">Інше</a>
                        </div>
                    </div>
                ...
                <div class="blog__posts">
                    ...
                    <div class="post">
                        ...
                        <div class="post__content">
                            <div class="post__date">25.10.2024</div>
                            <h4 class="post__title">
                                Ідеї для дизану вишуканого ресторану?
                            </h4>
                            <p class="post__text">
                                Створення розкішного ресторану – це складний, але захопливий процес, у якому кожен елемент, від
                                інтер'єру до освітлення, має підкреслювати загальну концепцію.
                            </p>
                    ...
                    <div class="post">
                        ...
                        <div class="post__content">
                            <div class="post__date">25.10.2024</div>
                            <h4 class="post__title">
                                Що таке дизан в стилі лофт?
                            </h4>
                            <p class="post__text">
                                Стиль лофт відомий своїм мінімалізмом, відкритими просторами та незавершеними елементами, що
