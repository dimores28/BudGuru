    ...
    <section class="blog">
        <div class="blog__container">
            ...
            <?php if($posts_query->max_num_pages> 1): ?>
                <div class="blog__pagination pagination" data-max-pages="<?php echo $posts_query->max_num_pages; ?>">
                    ...
                    <a href="#" class="pagination__next <?php echo ($paged >= $posts_query->max_num_pages) ? 'disabled' : ''; ?>" 
                       data-page="<?php echo ($paged < $posts_query->max_num_pages) ? $paged + 1 : $posts_query->max_num_pages; ?>">
